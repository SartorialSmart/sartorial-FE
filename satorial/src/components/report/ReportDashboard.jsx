...
const cards = [
  { title: "Total Orders", value: "112", icon: <Mail />, bg: "bg-green-100" },
  { title: "Total Delivered", value: "112", icon: <Mail />, bg: "bg-blue-100" },
  { title: "Total Clients", value: "112", icon: <User />, bg: "bg-yellow-100" },
  {
  ...
  { title: "Total Staff", value: "112", icon: <User />, bg: "bg-teal-100" },
];
